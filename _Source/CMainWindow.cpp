...
std::unique_ptr<const QColor> CMainWindow::RandomColorRGB() const
{
	...
	return std::make_unique<const QColor>(QColor::fromRgb(x, y, z, w));
}

std::unique_ptr<const QColor> CMainWindow::RandomColorGRY() const
{
	const int w = Alpha_QCheckBox.isChecked() ? CCore::RandomPInt(WMin_QDSpinBox.Result(), WMax_QDSpinBox.Result(), WMax_QDSpinBox.Limit() + 1) : 255;
	const int x = CCore::RandomPInt(XMin_QDSpinBox.Result(), XMax_QDSpinBox.Result(), XMax_QDSpinBox.Limit() + 1);

	return std::make_unique<const QColor>(QColor::fromRgb(x, x, x, w));
}

std::unique_ptr<const QColor> CMainWindow::RandomColorHSL() const
{
	const int w = Alpha_QCheckBox.isChecked() ? CCore::RandomPInt(WMin_QDSpinBox.Result(), WMax_QDSpinBox.Result(), WMax_QDSpinBox.Limit() + 1) : 255;
	const int x = CCore::RandomPInt(XMin_QDSpinBox.Result(), XMax_QDSpinBox.Result(), XMax_QDSpinBox.Limit() + 1);
	const int y = CCore::RandomPInt(YMin_QDSpinBox.Result(), YMax_QDSpinBox.Result(), YMax_QDSpinBox.Limit() + 1);
	...
	return std::make_unique<const QColor>(QColor::fromHsl(x, y, z, w));
}

std::unique_ptr<const QColor> CMainWindow::RandomColorHSV() const
{
	const int w = Alpha_QCheckBox.isChecked() ? CCore::RandomPInt(WMin_QDSpinBox.Result(), WMax_QDSpinBox.Result(), WMax_QDSpinBox.Limit() + 1) : 255;
	const int x = CCore::RandomPInt(XMin_QDSpinBox.Result(), XMax_QDSpinBox.Result(), XMax_QDSpinBox.Limit() + 1);
	const int y = CCore::RandomPInt(YMin_QDSpinBox.Result(), YMax_QDSpinBox.Result(), YMax_QDSpinBox.Limit() + 1);
	...
	return std::make_unique<const QColor>(QColor::fromHsv(x, y, z, w));
}
