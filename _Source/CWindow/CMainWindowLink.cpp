...
{
	connect(Title_QMenu.addAction(QPixmap(":/Direction/Right.svg").scaled(10, 10, Qt::AspectRatioMode::KeepAspectRatio, Qt::TransformationMode::SmoothTransformation), "Configuration"), &QAction::triggered, this, &CMainWindow::State_Config_QAction_triggered, CCore::connection);
	...
	Icon_QPushButton.MouseLeftReleased = [&] { State_Icon_QPushButton_MouseLeftReleased(); };
	...
	Minimize_QPushButton.MouseLeftReleased = [&] { showMinimized(); };
	Close_QPushButton.MouseLeftReleased = [&] { close(); };

	connect(&XMin_QDSpinBox, &QDoubleSpinBox::valueChanged, &XMin_QDSpinBox, &CDoubleSpinBox_Space::ValueChanged, CCore::connection);
	connect(&XMax_QDSpinBox, &QDoubleSpinBox::valueChanged, &XMax_QDSpinBox, &CDoubleSpinBox_Space::ValueChanged, CCore::connection);
	connect(&YMin_QDSpinBox, &QDoubleSpinBox::valueChanged, &YMin_QDSpinBox, &CDoubleSpinBox_Space::ValueChanged, CCore::connection);
	connect(&YMax_QDSpinBox, &QDoubleSpinBox::valueChanged, &YMax_QDSpinBox, &CDoubleSpinBox_Space::ValueChanged, CCore::connection);
	connect(&ZMin_QDSpinBox, &QDoubleSpinBox::valueChanged, &ZMin_QDSpinBox, &CDoubleSpinBox_Space::ValueChanged, CCore::connection);
	connect(&ZMax_QDSpinBox, &QDoubleSpinBox::valueChanged, &ZMax_QDSpinBox, &CDoubleSpinBox_Space::ValueChanged, CCore::connection);
	connect(&WMin_QDSpinBox, &QDoubleSpinBox::valueChanged, &WMin_QDSpinBox, &CDoubleSpinBox_Space::ValueChanged, CCore::connection);
	connect(&WMax_QDSpinBox, &QDoubleSpinBox::valueChanged, &WMax_QDSpinBox, &CDoubleSpinBox_Space::ValueChanged, CCore::connection);

	RGB_QRadioButton.Toggled = [&] { State_RGB_QRadioButton_Toggled(); };
	GRY_QRadioButton.Toggled = [&] { State_GRY_QRadioButton_Toggled(); };
	HSL_QRadioButton.Toggled = [&] { State_HSL_QRadioButton_Toggled(); };
	HSV_QRadioButton.Toggled = [&] { State_HSV_QRadioButton_Toggled(); };

	connect(&Alpha_QCheckBox, &QAbstractButton::toggled, this, &CMainWindow::State_Alpha_QCheckBox_toggled, CCore::connection);
	connect(&Alpha_QComboBox, &QComboBox::currentIndexChanged, this, &CMainWindow::State_Alpha_QComboBox_currentIndexChanged, CCore::connection);
	...
	connect(&Gamma_QDSpinBox, &QDoubleSpinBox::valueChanged, this, &CMainWindow::State_Gamma_QDSpinBox_valueChanged, CCore::connection);

	Pick_QPushButton.MouseLeftPressed = [&] { State_Pick_QPushButton_MouseLeftPressed(); };
	Pick_QPushButton.MouseRightPressed = [&] { State_Pick_QPushButton_MouseRightPressed(); };
	Pick_QPushButton.MouseMiddlePressed = [&] { State_Pick_QPushButton_MouseMiddlePressed(); };
	Pick_QPushButton.MouseReleased = [&] { State_Pick_QPushButton_MouseReleased(); };
	Pick_QPushButton.MouseMoved = [&] { State_Pick_QPushButton_MouseMoved(); };

	connect(&RGB1_QDSpinBox, &QDoubleSpinBox::valueChanged, &RGB1_QDSpinBox, &CDoubleSpinBox_Info::ValueChanged, CCore::connection);
	connect(&RGB2_QDSpinBox, &QDoubleSpinBox::valueChanged, &RGB2_QDSpinBox, &CDoubleSpinBox_Info::ValueChanged, CCore::connection);
	connect(&RGB3_QDSpinBox, &QDoubleSpinBox::valueChanged, &RGB3_QDSpinBox, &CDoubleSpinBox_Info::ValueChanged, CCore::connection);
	connect(&HSL1_QDSpinBox, &QDoubleSpinBox::valueChanged, &HSL1_QDSpinBox, &CDoubleSpinBox_Info::ValueChanged, CCore::connection);
	connect(&HSL2_QDSpinBox, &QDoubleSpinBox::valueChanged, &HSL2_QDSpinBox, &CDoubleSpinBox_Info::ValueChanged, CCore::connection);
	connect(&HSL3_QDSpinBox, &QDoubleSpinBox::valueChanged, &HSL3_QDSpinBox, &CDoubleSpinBox_Info::ValueChanged, CCore::connection);
	connect(&HSV1_QDSpinBox, &QDoubleSpinBox::valueChanged, &HSV1_QDSpinBox, &CDoubleSpinBox_Info::ValueChanged, CCore::connection);
	connect(&HSV2_QDSpinBox, &QDoubleSpinBox::valueChanged, &HSV2_QDSpinBox, &CDoubleSpinBox_Info::ValueChanged, CCore::connection);
	connect(&HSV3_QDSpinBox, &QDoubleSpinBox::valueChanged, &HSV3_QDSpinBox, &CDoubleSpinBox_Info::ValueChanged, CCore::connection);
	connect(&LUMI_QDSpinBox, &QDoubleSpinBox::valueChanged, &LUMI_QDSpinBox, &CDoubleSpinBox_Info::ValueChanged, CCore::connection);
	connect(&INTP_QDSpinBox, &QDoubleSpinBox::valueChanged, &INTP_QDSpinBox, &CDoubleSpinBox_Info::ValueChanged, CCore::connection);
	connect(&ALPH_QDSpinBox, &QDoubleSpinBox::valueChanged, &ALPH_QDSpinBox, &CDoubleSpinBox_Info::ValueChanged, CCore::connection);
...
void CMainWindow::LinkStateDynamic()
{
	...
	RandomColor = [&] { return *RandomColorRGB(); };
	RefreshHex = [&] { RefreshHex3(); };
	RefreshBlock = [&] { RefreshBlock3RGB(); };
}