...
CMainWindowUI::CMainWindowUI() :
	...
	XMin_QDSpinBox(-255, 255, &Space_QWidget),
	XMax_QDSpinBox(-255, 255, &Space_QWidget),
	YMin_QDSpinBox(-255, 255, &Space_QWidget),
	YMax_QDSpinBox(-255, 255, &Space_QWidget),
	ZMin_QDSpinBox(-255, 255, &Space_QWidget),
	ZMax_QDSpinBox(-255, 255, &Space_QWidget),
	WMin_QDSpinBox(0, 255, &Space_QWidget),
	WMax_QDSpinBox(0, 255, &Space_QWidget),
...
{
	const QPoint center = QGuiApplication::screenAt(QCursor::pos())->geometry().center();
	...
	Icon_QPushButton.setIcon(QPixmap(":/Logo/Color Picker.svg").scaled(18, 18, Qt::AspectRatioMode::KeepAspectRatio, Qt::TransformationMode::SmoothTransformation));
	...
	Simple_QPushButton.setIcon(QPixmap(":/Button/Star.svg").scaled(14, 14, Qt::AspectRatioMode::KeepAspectRatio, Qt::TransformationMode::SmoothTransformation));
	...
	ATop_QPushButton.setIcon(QPixmap(":/Button/Spiral.svg").scaled(13, 13, Qt::AspectRatioMode::KeepAspectRatio, Qt::TransformationMode::SmoothTransformation));
	...
	Minimize_QPushButton.setIcon(QPixmap(":/Direction/Left.svg").scaled(13, 13, Qt::AspectRatioMode::KeepAspectRatio, Qt::TransformationMode::SmoothTransformation));
	...
	Close_QPushButton.setIcon(QPixmap(":/Button/Radio.svg").scaled(13, 13, Qt::AspectRatioMode::KeepAspectRatio, Qt::TransformationMode::SmoothTransformation));
	...
	LUMI_QDSpinBox.setReadOnly(true);
	...
	SlotBack_QLabel.setPixmap(QPixmap(":/Checker/Slot.svg").scaled(50, 50, Qt::AspectRatioMode::KeepAspectRatio, Qt::TransformationMode::SmoothTransformation));
	Slot_QWidget.setGeometry(260, 390, 50, 50);
	Slot_QWidget.setAutoFillBackground(true);
	SlotMask_QLabel.setGeometry(260, 390, 50, 50);
	SlotMask_QLabel.setPixmap(QPixmap(":/Target/Mask.svg").scaled(50, 50, Qt::AspectRatioMode::KeepAspectRatio, Qt::TransformationMode::SmoothTransformation));
}