...
CConfig::CConfig(const std::function<void(int)> &__restrict__ state_FloatPrec_QSpinBox_valueChanged, const QWidget *__restrict__ parent) :
	Title_QLabel(this),
	...
	state_FloatPrec_QSpinBox_valueChanged(state_FloatPrec_QSpinBox_valueChanged)
{
	...
	CustomSlot_QPushButton.setIcon(QPixmap(":/Direction/Right.svg").scaled(6, 6, Qt::AspectRatioMode::KeepAspectRatio, Qt::TransformationMode::SmoothTransformation));
	...
	connect(&StartSlots_QComboBox, &QComboBox::currentIndexChanged, this, &CConfig::State_StartSlots_QComboBox_currentIndexChanged, CCore::connection);
	...
	connect(&FloatPrec_QSpinBox, &QSpinBox::valueChanged, this, &CConfig::State_FloatPrec_QSpinBox_valueChanged, CCore::connection);

	CustomSlot_QPushButton.MouseLeftReleased = [&] { State_CustomSlot_QPushButton_MouseLeftReleased(); };
