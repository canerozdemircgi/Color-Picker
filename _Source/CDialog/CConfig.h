...
class CConfig final : public QDialog
{
	Q_OBJECT

public:
	explicit CConfig(const std::function<void(int)> &__restrict__ state_FloatPrec_QSpinBox_valueChanged, const QWidget *__restrict__ parent);
